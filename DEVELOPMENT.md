...
- [Nault](https://github.com/banano-trade/Banano-Nault) - The main wallet application (UI + Seed Generation/Block Signing/Etc).
...
```bash
git clone https://github.com/banano-trade/Banano-Nault
cd Nault
npm install
```
